...
export default function DebugTools() {
  ...
  function initDebugUI() {
    ...
    //defaul settings
    let styleClass = 'db-dark', positionClass = 'db-bottom-right', sizeClass = 'db-medium';
    ...
    container.innerHTML = `
      ...
      <div id="debug-window" class="${styleClass} ${positionClass} ${sizeClass}">
        <div id="debug-tabs">
    ...
    const setBut = document.querySelectorAll('#set-tabs button');
    ...
    setBut.onclick = () => settingsScreen(contentEl);
    ...
    tabs.forEach(tab => {
      tab.onclick = () => {
        ...
        else if (type === 'settingsEl') settingsScreen(settingsEl);
      };
    });
